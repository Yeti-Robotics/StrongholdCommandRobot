...
public class RobotMap {
	...
	public static final double ARM_SPEED_OPERATOR = 0.15;
	...
	//Shooter
	public static final int[] SHOOTER_TILT_SOLENOID_PORTS = {4, 5};
	...
	public static final double SHOOTER_TILT_CAN_TALON_SPEED_STRING = 0.1;
