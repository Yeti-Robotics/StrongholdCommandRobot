...
public class RobotMap {
	...
	public static final double USER_SPEED_CONTROL_MODIFIER = 1.0;
	...
	public static final double SHOOTER_TILT_CAN_TALON_SPEED = 0.3;
	...
	public static final int ENCODER_DEGREES_PER_PULSE = 10; // update ----------------------------------
	public static final int DISTANCE_PER_PULSE = 1; // update ---------------------------------
	...
	public static double convertEncFeedbackToDegrees(double feedback){
		return ENCODER_DEGREES_PER_PULSE * feedback;
	}
	
	public static double convertEncFeedbackToDriveDistance(double feedback){
		return DISTANCE_PER_PULSE * feedback;
	}
}
