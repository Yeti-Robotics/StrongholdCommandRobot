package org.usfirst.frc.team3506.robot.splinegenerator;
 ...
 */
	...
	//main program
	public static double[][][] runCalculationForVelocities(double[][] waypoints, double totalTime)
	{
		...
		double robotTrackWidth = RobotMap.ROBOT_TRACK_WIDTH_FT; //distance between left and right wheels, feet
		...
		double[][][] velocities = {path.smoothLeftVelocity, path.smoothRightVelocity};
		return velocities;
	}
